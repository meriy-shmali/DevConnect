...
const handleAddComment = ({ postId, text }) => {
  ...
  return (
    <div className={`bg-white dark:bg-dark-post-background rounded-3xl shadow-xl w-[600px] md:w-[900px] h-fit p-8 border border-gray-300 flex-col space-y-10  justify-center ${customWidth || 'w-[600px] md:w-[900px]'}`}>
    <Trending post={post}/>
    <HeaderPost post={post}  customClass={HeaderClass}/>
    <BodyPost post={post} customClass={bodyClass}/>
    <Reaction post={post}  onOpenReaction={handleTogglePanel} onClose={handleClose} reactionData={reactionData}
     ...
     onOpenComments={ handleToggleComments}  customClass={reactionClass}/>
      <AnimatePresence>
    {paneltype && (
  <SidebarPanel
  key={paneltype}
