...
const NotificationItem = ({ item, onClick }) => {
  ...
  return (
    // ✅ onClick يستقبل الدالة من الأب مباشرة (handleItemClick(item))
    <div
      onClick={onClick}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-0.5">
          <p className="text-[18px] leading-snug text-black mb-2">
            ...
            {" "}
            <span className={item.is_read ? '!text-black dark:!text-gray-400' : '!font-bold text-gray-600 dark:text-gray-200'}>
