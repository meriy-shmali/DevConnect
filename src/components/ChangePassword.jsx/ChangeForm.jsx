   ...
   <FormField
      ...
      render={({ field }) => (
        <FormItem className='flex flex-col md:flex-row md:items-center gap-2 md:gap-4  w-full max-w-full overflow-hidden'>
          <FormLabel className=" text-main-text dark:text-gray-50 md:min-w-[300px] lg:min-w-[400px] flex-shrink-0 text-[30px] md:text-[40px]  lg:text-[40px]">{t('current_password')}:</FormLabel>
          <div className='flex flex-col w-full max-w-[500px] translate-y-1 md:translate-y-2'>
          <FormControl>
            <InputGroup className=" group hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-2xl bg-white border-black border w-full px-3 max-w-[500px] h-[46px] mb-4
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className='flex flex-col md:flex-row md:item-center gap-2 md:gap-4  w-full max-w-full overflow-hidden'>
          <FormLabel className="text-main-text dark:text-gray-50 md:min-w-[300px] lg:min-w-[400px] flex-shrink-0 text-[30px] md:text-[40px]  lg:text-[40px]">{t('new_password')}:</FormLabel>
          <div className='flex flex-col w-full max-w-[500px]  translate-y-1 md:translate-y-2'>
          <FormControl>
           <InputGroup className=" group hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-2xl
           bg-white border-black border w-full px-3 max-w-[500px] min-h-[46px] mb-4
            focus-within:ring-1 focus-within:ring-blue-button focus-within:border-blue-button transition-all 
            focus-within: outline-none dark:bg-dark-post-background dark:border-white/20">
              <InputGroupInput
                {...field}
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className='flex flex-col md:flex-row md:item-center gap-2 md:gap-4  w-full max-w-full overflow-hidden'>
          <FormLabel className="text-main-text dark:text-gray-50 md:min-w-[300px] lg:min-w-[400px] flex-shrink-0
           text-[30px] md:text-[40px]  lg:text-[40px]">{t('confirm_password')} </FormLabel>
          <div className='flex flex-col w-full max-w-[500px]  translate-y-1 md:translate-y-2'>
          <FormControl>
            <InputGroup className=" group hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-2xl
            bg-white border-black border w-full px-3 max-w-[500px] h-[46px] mb-4
            focus-within:ring-1 focus-within:ring-blue-button focus-within:border-blue-button transition-all
             focus-within: outline-none dark:bg-dark-post-background dark:border-white/20">
              <InputGroupInput
                {...field}
