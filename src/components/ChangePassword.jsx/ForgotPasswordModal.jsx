          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {step === 1 ? (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-1 overflow-hidden">
                    <FormLabel className="md:text-xl text-lg font-medium text-black dark:text-gray-50 mb-4 ms-1.5">{t('enter_your_email')}:</FormLabel>
                    <FormControl>
                      <Input placeholder="" 
                         {...field} 
                          ...
                          className=" hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-xl
                         md:text-md text-sm dark:text-dark-text dark:text-gray-50
                         group bg-white border-black border w-full px-3 max-w-[500px] h-fit mb-1
                    ...
                    <FormMessage className="  md:text-lg text-sm" />
                  </FormItem>
                )}
              />
               ) : (
              <>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-1">
                      <FormLabel className="md:text-xl text-lg font-medium mb-4 text-black dark:text-gray-50">{t('enter_code')}:</FormLabel>
                      <FormControl>
                        <Input placeholder="" 
                        {...field} 
                         onChange={(e)=>{field.onChange(e);
                        ...
                        className=" hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-2xl
                         md:text-lg text-sm dark:text-dark-text dark:text-gray-50
                         group bg-white border-black border w-full px-3 max-w-[500px] h-fit mb-1
                         focus-within:ring-1 focus-within:ring-blue-button focus-within:border-blue-button transition-all 
                         focus-within: outline-none dark:bg-dark-post-background dark:border-white/20" />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className='flex flex-col space-y-1'>
                     <FormLabel className="md:text-xl text-lg mb-4 font-medium text-black dark:text-gray-50">{t('new_password')}:</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                     <FormItem className='flex flex-col  space-y-1'>
                      <FormLabel className="md:text-xl text-lg mb-4 font-medium text-black dark:text-gray-50">{t('confirm_password')} </FormLabel>
                        <div className='flex flex-col w-full max-w-[500px]  translate-y-1 md:translate-y-2'>
                         <FormControl>
                           <InputGroup className=" hover:bg-hover-placeholder bg-light-placeholder shadow  rounded-2xl
                         md:text-lg text-sm dark:text-dark-text dark:text-gray-50
            ...
            <div className="flex justify-center mt-6">
              <Button 
                 ...
                 onClick={onSubmit}     
               className=' w-fit hover:bg-blue-800 text-white rounded-sm 
                transition-colors px-1.5 py-0 bg-blue-button hover:bg-blue-700 text-text-button  lg:text-sm text-xs
               !cursor-pointer '
