...
const ProfilePage = ({ userData }) => {
  ...
  return (
    ...
    [&_div]:space-x-0 [&>div:last-child]:!me-0` :`flex justify-between items-center w-[112%] -ml-[6%] scale-90  px-0 gap-0 
...
: `md:scale-100 scale-65 origin-center gap-x-10 px-0 flex justify-between pt-1 pb-6 mb-[-10px] `} // تغيير هوامش التفاعلات
/>
                  </div>
