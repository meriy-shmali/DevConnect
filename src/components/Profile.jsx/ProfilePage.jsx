    ...
    <div className="min-h-screen bg-main-background dark:bg-dark-background dark:text-gray-50 dark:bg-[#1E1E1E]   transition-colors duration-300">
     ...
     <PostCard 
      ...
      HeaderClass={isMobile ? `
                 ...
                 `}
      bodyClass={isMobile ? "h-[300px] scale-90 origin-top px-4 py-0 mb-[-10px] text-sm overflow-hidden custom-scrollbar" :" h-[300px] scale-90 origin-top px-4 py-0 mb-[-10px] text-sm overflow-hidden custom-scrollbar  "} // تحديد ارتفاع البوست
      reactionClass={isMobile ? ` w-full max-w-[350px] mx-auto scale-65 origin-center gap-x-0.5 flex justify-center border-t pt-1 pb-6 mb-[-10px] 
                                         [&~div]:!max-w-[320px] [&~div]:!w-full [&~div]:mx-auto 
                                         [&~div_div]:!max-w-full [&~div_div]:box-border [&_.._div]:max-w-[320px]` :`md:scale-75 scale-65 origin-center gap-x-1 flex justify-center border-t pt-1 pb-6 mb-[-10px] `} // تغيير هوامش التفاعلات
/>
                  </div>
