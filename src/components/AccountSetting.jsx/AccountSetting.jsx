         ...
         <div className="flex items-center justify-between w-full  pb-4 dark:border-white/10">
          ...
          {t('account_setting')}
           ...
           <button
             ...
             className="flex items-center gap-2 px-4 py-2 mr-8  bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-full transition-all group border dark:border-zinc-700"
            >
